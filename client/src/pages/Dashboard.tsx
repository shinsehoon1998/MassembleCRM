        ...
        <Card className="lg:col-span-2 border-gray-100">
          <CardHeader className="border-b border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" className="text-sm text-keystart-blue hover:text-keystart-blue">
                전체보기 →
              </Button>
            </div>
          </CardHeader>
                    ...
                    {recentCustomers?.map((customer) => (
                      <tr key={customer.id} className="hover:bg-gray-50" data-testid={`row-customer-${customer.id}`}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <Button variant="ghost" size="sm" className="text-keystart-blue hover:text-keystart-blue mr-3">
