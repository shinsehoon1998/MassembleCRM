  ...
  async getCustomers(params: {
    ...
    const customersData = await db
      .select({
        ...
        memo2: customers.memo2,
        memo3: customers.memo3,
        memo4: customers.memo4,
        memo5: customers.memo5,
        memo6: customers.memo6,
        memo7: customers.memo7,
        memo8: customers.memo8,
        memo9: customers.memo9,
        memo10: customers.memo10,
